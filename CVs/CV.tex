...
% \\ Associated Faculty: Prashant Nalini Vasudevan \\\textit{November 2023 - Ongoing} 

\employer{Supervisor: Prashant Nalini Vasudevan}
\location{\textbf{National University of Singapore}}
\dates{\textit{November 2023 - Ongoing}}
...
\employer{Advisor: Omkant Pandey}
\location{\textbf{Stony Brook University}}
\dates{\textit{August 2017 - September 2023}}
\title{{\sl PhD}\\ Computer Science \& Engineering Department}
\begin{position}
\textit{Thesis:} Eﬃcient Approaches to Emerging Cryptography
...
\employer{Advisors: Bhavana Kanukurthi \& Himanshu Tyagi}
\location{\textbf{Indian Institute of Science}}
\dates{\textit{August 2012 - May 2017}}
\title{{\sl Master of Science (Research)}\\ {\sl Bachelor of Science (Research), First Class}\\ Major: Mathematics\\ Undergraduate Department}
\begin{position}
\textit{Undergraduate Thesis:} Information Theoretic Secure Computation
\end{position}
...
% %GPA: 5.8/8 \\
% {\sl Bachelor of Science (Research), First Class}, Undergraduate Department, 2016 (Math major)\hfill \newline
% %GPA: 6.1/8
...
\textbf{Weak Zero Knowledge and One-Way Functions}\\ {\it In Submission} \\
With Yunqi Li \& Prashant Nalini Vasudevan \\

% \employer{With Changrui Mu \& Prashant Nalini Vasudevan}
% \location{}
% \dates{{\it In Submission}}
% \title{\textbf{Public Key Encryption from the MinRank Problem}}
% \begin{position}

% \end{position}

% \employer{With Andrej Bogdanov, Yunqi Li \& Prashant Nalini Vasudevan }
% \location{}
% \dates{{\it In Submission}}
% \title{\textbf{Decoding Balanced Linear Codes With Preprocessing}}
% \begin{position}
% % Abs
% \end{position}
...
\textbf{Public Key Encryption from the MinRank Problem}\\ {\it EUROCRYPT 2026} \\
With Changrui Mu \& Prashant Nalini Vasudevan \\

\textbf{Decoding Balanced Linear Codes With Preprocessing}\\ {\it ITCS 2026} \\
With Andrej Bogdanov, Yunqi Li \& Prashant Nalini Vasudevan \\

\textbf{The Round Complexity of Black-Box Post-Quantum Secure Computation}\\ {\it CRYPTO 2025} \\
With Xiao Liang, Omkant Pandey \& Takashi Yamakawa \\


\textbf{On the Necessity of Uncloneable Proof and Advice States}\\ {\it STOC 2025} \\
With Supartha Podder \& Srijita Kundu \\


\textbf{Building Unclonable Cryptography: A Tale of Two No-cloning Paradigms}\\ {\it SECRYPT 2023} \\
With Ghada Almashaqbeh \\


\textbf{A Note on the Post-Quantum Security of (Ring) Signatures}\\ {\it PKC 2022} \\
With Kai-Min Chung, Xiao Liang, \& Giulio Malavolta \\


\textbf{Compact Ring Signatures from Learning With Errors}\\ {\it CRYPTO 2021} \\
With Sanjam Garg, Mohammad Hajiabadi, Dakshita Khurana, Xiao Liang, Giulio Malavolta, Omkant Pandey \& Sina Shiehian \\


\textbf{Improved Black-Box Constructions of Composable Secure Computation}\\ {\it ICALP 2020} \\
...
\textbf{On the Necessity of Uncloneable Proof and Advice States}\\ Invited Talk at SoC AlgoTheory Seminar at \textbf{NUS}, October 2025.\\ Invited Talk at CS Departmental Seminar at \textbf{CUHK}, August 2025.\\ Invited Long Talk at \textbf{AQIS 2025}, August 2025

% \textbf{On the Necessity of Uncloneable Proof and Advice States}, invited Long Talk at \textbf{AQIS 2025}, August 2025.

% \textbf{On the Necessity of Uncloneable Proof and Advice States}, invited Talk at CS Departmental Seminar at \textbf{CUHK}, August 2025.

\textbf{Post-Quantum Black-Box Secure Computation from Minimal Assumptions}\\ Invited Talk at SoC AlgoTheory Seminar at \textbf{NUS}, February 2024


\section{SERVICE}

Invited Reviewer for \textbf{Journal of Cryptology} [2023], \textbf{EUROCRYPT} [2023-2026], \\ \textbf{CRYPTO} [2023-2025], \textbf{ASIACRYPT} [2022,2024,2025], \textbf{TCC} [2021-2025], \\ \textbf{PKC} [2019,2024,2025], \textbf{TQC} [2024,2025], \textbf{ITC} [2023], \textbf{SCN} [2022], \textbf{QCRYPT} [2023], \textbf{WWW S\&P} [2026]

Organizer of the {\bf AlgoTheory Seminar} at School of Computing at NUS, since January 2024


\section{EXPERIENCE}

\textbf{Mentorship}: \\ Co-supervised 3 undergraduates as part of the {\bf Odyssey Summer Research} program at NUS School of Computing for advanced undergraduates 
\\ Co-supervising an undergraduate {\bf Final Year Project} at NUS School of Computing (as part of the FYP program)

\textbf{Teaching \& Assistantship}: \\ Modern Cryptography, Analysis of Algorithms, Foundations of Computer Science(UG)
...
Recipient of the prestigious \textbf{Kishore Vaigyanik Protsahan Yojana (KVPY) fellowship} in 2012, a National Fellowship
in Basic Sciences, funded by the Department of Science and Technology (DST), Government of India for showing promise in research in basic science (All India Rank: 159)
\par
